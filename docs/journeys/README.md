...
This folder contains the primary User Journeys (UJs) used to verify the AeroDash system's operational integrity.

## Traceability Strategy
* **Mapping:** `User Journey` -> verified -> `Requirement`
* *(Note: The link from Requirement to Hazard is maintained in the Safety Traceability Matrix)*
