...
| **<a name="REQ-UI-005">REQ-UI-005</a>** | The system shall display the 5 most recently used airports at the top of the airport selection interface. | Ensure the pilot is always aware of the active unit to prevent conversion errors (e.g. Liter vs. Gallon). | P3 |  n/a | Draft |
...
| **<a name="REQ-UI-008">REQ-UI-008</a>** | The system shall display a visual warning message when numeric inputs are outside standard operational ranges ($QNH \notin [950, 1100]\,\text{hPa}$, Temperature $\notin [-40, +50]\,\text{°C}$), but shall allow entry confirmation. | Prevents fat-finger errors during planning. | P1 |  n/a | Draft |
