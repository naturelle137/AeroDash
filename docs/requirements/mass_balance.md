...
| **<a name="REQ-MB-003">REQ-MB-003</a>** | While calculating mass and balance, the system shall update the CG envelope chart synchronously with user input. | Instant situational awareness for the pilot. | P2 |  n/a | Draft |
