...
| `WARN-AC-001`  | Registration Duplicate             | `WARNING`  | [REQ-AC-003](../requirements/aircraft_management.md#REQ-AC-003)        | Mass & Balance (and future modules) when active aircraft context has fleet status `draft`.                                                                                               |
