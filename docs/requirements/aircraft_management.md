...
| **<a name="REQ-AC-004">REQ-AC-004</a>** | The system shall import aircraft profiles from external exchange files. | Facilitates offline backup and sharing of profiles without recompilation. | P2 | n/a | Approved |
