...
| <a name="REQ-AC-006">REQ-AC-006</a> | The system shall allow the user to create, update, and delete "Passenger Profiles" defined by a Name and a Standard Weight. | Facilitates [REQ-UI-006](./user_interface.md#REQ-UI-006) (Quick Selection) and standardized fleet operations. | P2 | n/a | Draft |
