...
| **<a name="REQ-SYS-004">REQ-SYS-004</a>** | The system shall support the following units for calculation and display: <ul><li>Volume: l, gal (US)</li> <li>Mass: kg, lb</li> <li>Speed: km/h, mph, kt, m/s</li> <li>Arm: m, in, ft</li> <li>Moment: kg·m, in-lb, ft-lb</li></ul> | Ensures compatibility with POH data from both metric (EASA) and imperial (FAA) manufacturers. | P1 | n/a | Approved |
