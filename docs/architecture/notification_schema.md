...
| `INFO-API-001` | Online Weather Service unavailable.                             |   `INFO`   | [API](../api/api.md)                                                   | When external weather API requests fail (e.g., 503).                                                                                                                                     |
| `INFO-API-002` | Online Airport Data unavailable.                                |   `INFO`   | [API](../api/api.md)                                                   | When external airport database requests fail (e.g., 503).                                                                                                                                |
| `INFO-API-003` | Share code not created. Please try again.                       |   `INFO`   | [API](../api/api.md)                                                   | When share code generation API request fails (e.g., 500).                                                                                                                                |
| `INFO-API-004` | Share code expired or invalid or service currently unavailable. |   `INFO`   | [API](../api/api.md)                                                   | When retrieving a profile using a share code fails (e.g., 404, 503).                                                                                                                     |
